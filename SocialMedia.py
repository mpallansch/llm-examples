...
st.caption("Takes the content of an article written for a technical audience and rewrites it for a social media post.")
...
if st.button("Rewrite"):
    ...
    response = client.chat.completions.create(model="gpt-4o", messages=[
        {"role": "system", "content": "The following is an article written for a technical audience. Rewrite it for a social media post."},
