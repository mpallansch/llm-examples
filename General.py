...
st.title("General Public")
st.caption("Takes the content of an article written for a technical audience and rewrites it for the general public.")
...
if st.button("Rewrite"):
    ...
    response = client.chat.completions.create(model="gpt-4o", messages=[
        {"role": "system", "content": "The following is an article written for a technical audience. Rewrite it for the general public. Use plain language and a thrid-grade reading level."},
